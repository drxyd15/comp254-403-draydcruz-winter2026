...
public class exercise3 {
    public static void find(String path, String filename) {
     ...
     // Helper method for recursion. Checks the current file/folder, then recurses into children if it's a directory.
    private static void findRecursive(File current, String filename) {

        // Check current text (file or directory) name
        // File.getName() returns just the last part (ex. "test.txt")
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nSearching...\n");
        find(path, filename);       // implement find()
